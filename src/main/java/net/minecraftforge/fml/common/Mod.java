...
//import net.net.minecraftforge.common.MinecraftForge;
//import net.net.minecraftforge.fml.client.IModGuiFactory;
//import net.net.minecraftforge.fml.common.event.*;
//import net.net.minecraftforge.fml.common.event.FMLInterModComms.IMCEvent;
//import net.net.minecraftforge.fml.common.network.NetworkCheckHandler;
//import net.net.minecraftforge.fml.common.registry.GameRegistry;
//import net.net.minecraftforge.fml.common.versioning.VersionRange;
 ...
 * represent the mod to other Mods in the system. It will be sent various subclasses of {@link }
 ...
 *
 *      // Mark this method for receiving an {@link } (in this case, it's the {@link })
 *      {@literal @}EventHandler public void preInit(FMLPreInitializationEvent event)
 *      {
 *          // Do stuff in pre-init phase (read2ObservableList config, create blocks and items, register them)
 *      }
 * }
 * }
 * </pre>
...
public @interface Mod
{
     ...
     *
     * Any incorrectness of the fingerprint, be it missing or wrong, will result in the {@link }
    ...
    /**
     * An optional GUI factory for this mod. This is the name of a class implementing {@link } that will be instantiated
     * on the client side, and will have certain configuration/options guis requested from it.
     *
     * @return The name of a class implementing {@link }
     */
     ...
     * <ul>
     * <li> {@link } : Run before anything else. Read your config, create blocks,
     * items, etc, and register them with the {@link }.</li>
     * <li> {@link } : Do your mod setup. Build whatever data structures you care about. Register recipes,
     * send {@link } messages to other mods.</li>
     * <li> {@link } : Handle interaction with other mods, complete your setup based on this.</li>
     * </ul>
     ...
     * <ul>
     * <li> {@link } : Use if you need to handle something before the server has even been created.</li>
     * <li> {@link } : Do stuff you need to do to set up the server. register commands, tweak the server.</li>
     * <li> {@link } : Do what you need to with the running server.</li>
     * <li> {@link } : Do what you need to before the server has started it's shutdown sequence.</li>
     * <li> {@link } : Do whatever cleanup you need once the server has shutdown. Generally only useful
     * on the integrated server.</li>
     * </ul>
     * The second set of events are more specialized, for receiving notification of specific
     * information.
     * <ul>
     * <li> {@link } : Sent just before {@link }
     * if something is wrong with your mod signature</li>
     * <li> {@link } : Sent just after {@link } if you have IMC messages waiting
     * from other mods</li>
     * </ul>
     *
     * @author cpw
    ...
    /**
     * A class which will be subscribed to {@link } at mod construction time.
     */
    @Retention(RetentionPolicy.RUNTIME)
    @Target(ElementType.TYPE)
